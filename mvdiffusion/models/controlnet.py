...
from diffusers.models.embeddings import TextImageProjection, TextImageTimeEmbedding, TextTimeEmbedding, \
    TimestepEmbedding, Timesteps, ImageProjection, ImageTimeEmbedding, ImageHintTimeEmbedding
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalControlnetMixin):
    ...
    def __init__(
            ...
            # from cfg unet_from_pretrained_kwargs
        ...
        # 1. control net conditioning embedding
        # additional input for copied unet
        ...
        # use custom MV2D attention block
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, (CrossAttnDownBlock2D, DownBlock2D, CrossAttnDownBlockMV2D)):
