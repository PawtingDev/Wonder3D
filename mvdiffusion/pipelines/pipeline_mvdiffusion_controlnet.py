...
class MVDiffusionImagePipeline(DiffusionPipeline):
    ...
    def prepare_control_image(
        ...
        # else:
        #     # image batch size is the same as front view image batch size
    ...
    def __call__(
        ...
        # batch_size should be num_views * batch in cfg * 2
        # control_img should be same size as input condition image
        # (BxNv) C H W
        ...
        if isinstance(controlnet, ControlNetModel):
            control_img = self.prepare_control_image(
                image=control_img,
                width=width,
                height=height,
            ...
            for image_ in control_img:
                ...
                control_imgs.append(image_)

            control_img = control_imgs
            height, width = control_img[0].shape[-2:]
        else:
            assert False
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if guess_mode and do_classifier_free_guidance:
                    ...
                    controlnet_image_embeds = image_embeddings.chunk(2)[1]
                else:
                    control_model_input = latent_model_input
                    controlnet_image_embeds = image_embeddings
                ...
                down_block_res_samples, mid_block_res_sample = self.controlnet(
                    ...
                    encoder_hidden_states=controlnet_image_embeds,
